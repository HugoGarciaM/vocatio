...
export const TitleScreen: React.FC<TitleScreenProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-between p-6 bg-slate-950 text-slate-100 overflow-hidden select-none">
      ...
      <div className="relative z-10 w-full max-w-5xl flex items-center justify-between">
        <div className="flex items-center gap-2 bg-slate-900/80 border border-slate-800 px-3 py-1.5 rounded-xl backdrop-blur-md">
          ...
          <span className="text-[11px] font-retro text-cyan-300">
        ...
        <button
          ...
          className="w-10 h-10 rounded-xl bg-slate-900/80 border border-slate-800 hover:border-cyan-400 text-slate-300 hover:text-cyan-300 flex items-center justify-center pixel-button cursor-pointer backdrop-blur-md"
        >
      ...
      <div className="relative z-10 text-center max-w-2xl my-auto space-y-4">
        {/* Medical Pixel Icon */}
        <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-tr from-cyan-600 to-blue-600 border-4 border-cyan-300 flex items-center justify-center text-slate-950 shadow-2xl animate-pulse">
          <Heart className="w-10 h-10 fill-current" />
        </div>

        <div>
          <span className="text-xs md:text-sm font-bold uppercase tracking-widest text-cyan-400 font-retro">
            RPG Educativo • Medicina & Psicología Médica
          </span>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-retro text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-blue-200 to-indigo-300 tracking-tight mt-2 drop-shadow-md">
            VOCATIO
          </h1>
          <h2 className="text-sm sm:text-base font-retro text-cyan-200 font-medium tracking-wide mt-1">
            El Camino del Médico
          </h2>
        </div>

        <p className="text-xs sm:text-sm text-slate-300 font-ui max-w-lg mx-auto leading-relaxed">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          {hasSavedGame && (
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-bold font-retro text-xs rounded-2xl pixel-button flex items-center justify-center gap-2 cursor-pointer shadow-xl"
            >
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold font-retro text-xs rounded-2xl pixel-button flex items-center justify-center gap-2 cursor-pointer shadow-xl"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-5 py-3.5 bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-cyan-400 text-slate-300 font-retro text-xs rounded-2xl pixel-button flex items-center justify-center gap-2 cursor-pointer"
          >
